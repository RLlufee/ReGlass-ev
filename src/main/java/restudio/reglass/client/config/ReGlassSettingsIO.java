...
public final class ReGlassSettingsIO {
    ...
    private static Data snapshot() {
        ...
        d.features_tooltips = c.features.tooltips;
        d.features_tooltipOpacity = c.features.tooltipOpacity;
    ...
    public static void apply(Data d) {
        ...
        c.features.tooltips = d.features_tooltips;
        c.features.tooltipOpacity = Math.max(0.0f, Math.min(1.0f, d.features_tooltipOpacity));
    ...
    public static class Data {
        ...
        public boolean features_tooltips = true;
        public float features_tooltipOpacity = 0.55f;
